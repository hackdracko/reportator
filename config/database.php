    ...
    */
    ...
    'connections' => [
        ...
        'cubogeneral' => [
            ...
            'database' => env('DB_DATABASE_CUBOGENERAL', 'forge'),
        ...
        'timberland' => [
            ...
            'host' => env('DB_HOST_SPINMASTER', 'localhost'),
            'port' => env('DB_PORT_SPINMASTER', '3306'),
            'database' => env('DB_DATABASE_TIMBERLAND', 'forge'),
            'username' => env('DB_USERNAME_SPINMASTER', 'forge'),
            'password' => env('DB_PASSWORD_SPINMASTER', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
        ...
        'underarmour' => [
            ...
            'host' => env('DB_HOST_SPINMASTER', 'localhost'),
            'port' => env('DB_PORT_SPINMASTER', '3306'),
            'database' => env('DB_DATABASE_UNDERARMOUR', 'forge'),
            'username' => env('DB_USERNAME_SPINMASTER', 'forge'),
            'password' => env('DB_PASSWORD_SPINMASTER', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
        ...
        'northface' => [
            ...
            'host' => env('DB_HOST_SPINMASTER', 'localhost'),
            'port' => env('DB_PORT_SPINMASTER', '3306'),
            'database' => env('DB_DATABASE_NORTHFACE', 'forge'),
            'username' => env('DB_USERNAME_SPINMASTER', 'forge'),
            'password' => env('DB_PASSWORD_SPINMASTER', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
